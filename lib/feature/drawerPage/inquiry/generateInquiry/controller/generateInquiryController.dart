...
//                               // var inquirydetail = provider.dataList[index];
//                               return Padding(
...
//                                               child: Text(
//                                                 "Generated On : ${provider.dataList[index]['dateTime']}",
//                                                 style: TextStyle(
//                                                     fontSize: 14,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Generated By : ${provider.dataList[index]['user_name']},${provider.dataList[index]['user_branch']}",
//                                                 style: TextStyle(
//                                                     fontSize: 14,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Enquery Type : ${provider.dataList[index]['enq_tyoe_name']}",
//                                                 style: TextStyle(
//                                                     fontSize: 14,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Enquiry For : ${provider.dataList[index]['person_name']},${provider.dataList[index]['branch_name']}",
//                                                 style: TextStyle(
//                                                     fontSize: 14,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Product/Service : ${provider.dataList[index]['product_service_type']} (${provider.dataList[index]['product_service_name']})",
//                                                 style: TextStyle(
//                                                     fontSize: 15,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Client: ${provider.dataList[index]['client']} ",
//                                                 style: TextStyle(
//                                                     fontSize: 15,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Contact Person : ${provider.dataList[index]['contact_person']} ",
//                                                 style: TextStyle(
//                                                     fontSize: 15,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                   const EdgeInsets.all(5.0),
//                                               child: Text(
//                                                 "Contact No.: ${provider.dataList[index]['contact_no']} ",
//                                                 style: TextStyle(
//                                                     fontSize: 15,
//                                                     fontWeight:
//                                                         FontWeight.bold),
...
//                                                         .spaceBetween,
//                                                 children: [
//                                                   provider.dataList[index]['op_status'] ==
//                                                           "closed"
//                                                       ? GestureDetector(
//                                                           onTap: () {
